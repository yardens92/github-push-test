...
/**
 * The Retcode application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Retcode retcode = (Retcode) context.getBean("retcode");
				...
				retcode.setParameter(new GlobalExecutorCtx().getContext(RetcodeCtx.class),inputValue);
