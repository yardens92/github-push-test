...
/**
 * The Retcode2 application can be started in three different ways
 * 1. Via mainframe JCL
	...
	public static void main(String[] args) {
		...
		if (StringUtils.hasText(appType) && WebApplicationType.NONE.equals(WebApplicationType.valueOf(appType.trim().toUpperCase())))
            ...
            GlobalExecutorCtx.load(CFApplication.class, context);
		 		...
		 		Retcode2 retcode2 = (Retcode2) context.getBean("retcode2");
				...
				retcode2.setParameter(new GlobalExecutorCtx().getContext(Retcode2Ctx.class),inputValue);
